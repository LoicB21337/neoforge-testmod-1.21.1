package net.kolbert.testmod.item;

import net.kolbert.testmod.TestMod;
import net.kolbert.testmod.item.custom.FuelItem;
import net.kolbert.testmod.item.custom.ChiselItem;
import net.kolbert.testmod.item.custom.HammerItem;
...
public class ModItems {
    ...
    public static final DeferredItem<ShovelItem> BISMUTH_SHOVEL = ITEMS.register("bismuth_shovel",
            ()-> new ShovelItem(ModToolTiers.BISMUTH, new Item.Properties()
                    .attributes(ShovelItem.createAttributes(ModToolTiers.BISMUTH, 1.5f, -3.4f))));
    ...
    public static final DeferredItem<HoeItem> BISMUTH_HOE = ITEMS.register("bismuth_hoe",
            ()-> new HoeItem(ModToolTiers.BISMUTH, new Item.Properties()
                    .attributes(HoeItem.createAttributes(ModToolTiers.BISMUTH, 0, -3))));
