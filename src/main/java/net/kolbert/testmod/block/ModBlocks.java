package net.kolbert.testmod.block;

import net.kolbert.testmod.TestMod;
import net.kolbert.testmod.block.custom.BismuthLampBlock;
import net.kolbert.testmod.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    public static final DeferredBlock<Block> MAGIC_BLOCK = registerBlock("magic_block",
            () -> new MagicBlock(BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops().sound(SoundType.AMETHYST_CLUSTER)));
    ...
    public static final DeferredBlock<Block> BISMUTH_LAMP = registerBlock("bismuth_lamp",
            () -> new BismuthLampBlock(BlockBehaviour.Properties.of().strength(2f).requiresCorrectToolForDrops().noOcclusion()
